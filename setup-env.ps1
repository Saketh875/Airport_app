...
Write-Host "1. npm run server:seed" -ForegroundColor WhiteWrite-Host "3. cd frontend && npm start" -ForegroundColor Whitee-Host "MongoDB Atlas Setup Helper" -ForegroundColor Green
Write-Host "=========================" -ForegroundColor Green
